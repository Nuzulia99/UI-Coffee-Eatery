        ...
        <div class="flex gap-10 items-stretch" style="height: fit-content;">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6" style="outline: 2px solid #3d5a73; outline-offset: -8px;">
              ...
              <div class="mb-6">
                ...
                <div class="category-tabs">
                  ...
                  <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button class="category-btn" data-category="<?php echo e($kat); ?>"><?php echo e($kat); ?></button>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
              </div>
              ...
              <div class="menu-grid" id="menuGrid">
                <?php $__currentLoopData = $produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="menu-item" data-id="<?php echo e($item->ProdukID); ?>" data-name="<?php echo e($item->NamaProduk); ?>" data-price="<?php echo e($item->Harga); ?>" data-stok="<?php echo e($item->Stok); ?>" data-category="<?php echo e($item->Kategori); ?>">
                    <?php if($item->Gambar): ?>
                      <img src="<?php echo e(asset($item->Gambar)); ?>" alt="<?php echo e($item->NamaProduk); ?>" class="menu-item-image">
                    <?php else: ?>
                    ...
                    <div class="menu-item-info">
                      <div class="menu-item-name" title="<?php echo e($item->NamaProduk); ?>"><?php echo e($item->NamaProduk); ?></div>
                      
                      <!-- Quantity Control -->
                      <div class="menu-qty-control" data-id="<?php echo e($item->ProdukID); ?>">
                      ...
                      <div class="menu-item-price">Rp <?php echo e(number_format($item->Harga, 0, ',', '.')); ?></div>
                      <div style="font-size: 10px; color: #999;">Stok: <?php echo e($item->Stok); ?></div>
                    </div>
                  </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </div>
          ...
          <div style="width: 32%;" class="flex-shrink-0 h-full">
            <div class="order-sidebar">
              ...
              <form action="<?php echo e(route('penjualan.transaction')); ?>" method="POST" id="orderForm">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\coffee\resources\views/penjualan/menu.blade.php ENDPATH**/ ?>