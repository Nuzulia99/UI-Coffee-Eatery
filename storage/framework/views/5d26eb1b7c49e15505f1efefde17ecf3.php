        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border" style="outline: 2px solid #3d5a73; outline-offset: -8px;">
            <div class="p-6 text-center">
              <?php if(Auth::user()->profile_photo): ?>
                <img src="<?php echo e(asset(Auth::user()->profile_photo)); ?>" alt="<?php echo e(Auth::user()->name); ?>" class="w-20 h-20 rounded-full object-cover border-4 border-slate-300 mx-auto mb-4">
              <?php else: ?>
              ...
              <?php endif; ?>
              <h5 class="mb-0 dark:text-white font-bold"><?php echo e(Auth::user()->name); ?></h5>
              <p class="text-sm text-slate-500 dark:text-slate-400 mb-4"><?php echo e(Auth::user()->email); ?></p>
              <div class="inline-block px-3 py-1 rounded-full text-xs font-semibold" style="background-color: #3d5a73; color: white;">
                <?php echo e(Auth::user()->level === 'administrator' ? 'Administrator' : 'Petugas'); ?>
          ...
          <div class="lg:col-span-2">
            <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border" style="outline: 2px solid #3d5a73; outline-offset: -8px;">
              ...
              <div class="p-6">
                <form method="POST" action="<?php echo e(route('petugas.update-profile')); ?>" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="mb-6">
                    ...
                    <input type="file" name="profile_photo" accept="image/jpeg,image/png,image/gif" class="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:border-slate-600 dark:text-white <?php $__errorArgs = ['profile_photo'];
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="mb-6">
                    ...
                    <input type="text" name="name" value="<?php echo e(Auth::user()->name); ?>" class="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:border-slate-600 dark:text-white <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="mb-6">
                    ...
                    <input type="text" name="username" value="<?php echo e(Auth::user()->username); ?>" class="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:border-slate-600 dark:text-white <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="mb-6">
                    ...
                    <input type="email" value="<?php echo e(Auth::user()->email); ?>" disabled class="block w-full px-3 py-2 border border-slate-300 rounded-lg bg-slate-100 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-400 text-slate-500">
                  </div>
                  ...
                  <div class="mb-6">
                    ...
                    <input type="password" name="password" class="block w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:border-slate-600 dark:text-white <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="flex gap-3">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="px-6 py-3 text-slate-700 font-bold rounded-lg border border-slate-300 transition-colors dark:text-white dark:border-slate-600">
...
<?php /**PATH C:\laragon\www\coffee\resources\views/petugas/profile.blade.php ENDPATH**/ ?>