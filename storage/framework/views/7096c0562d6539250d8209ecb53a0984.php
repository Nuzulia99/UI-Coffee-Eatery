...
<html>
  ...
  <body class="m-0 font-sans text-base antialiased font-normal dark:bg-slate-900 leading-default text-slate-500" style="background: #3d5a73; min-height: 100vh;">
    ...
    <aside class="fixed inset-y-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-hidden antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl dark:shadow-none dark:bg-slate-850 max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" aria-expanded="false">
      ...
      <div class="items-center block w-auto overflow-hidden">
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 bg-slate-500/13 dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors" href="<?php echo e(route('accounts.index')); ?>">
              <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
      ...
      <div class="w-full px-6 py-6 mx-auto">
        <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
          <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400">Total: <?php echo e($users->count()); ?> akun</p>
          </div>
          <div class="p-6">
                ...
                <?php else: ?>
                  <div class="overflow-x-auto">
                    <table>
                      ...
                      <tbody>
                        <?php $__currentLoopData = $administrators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td>
                              <div class="user-cell">
                                <?php if($user->profile_photo): ?>
                                  <img src="<?php echo e(asset($user->profile_photo)); ?>" alt="<?php echo e($user->name); ?>" class="avatar-img">
                                <?php else: ?>
                                ...
                                <div class="user-info">
                                  ...
                                  <div class="user-email"><?php echo e($user->created_at->format('d M Y')); ?></div>
                                </div>
                              </div>
                            </td>
                            <td>
                              <span style="color: #3b82f6; font-weight: 500;"><?php echo e($user->username); ?></span>
                            </td>
                            <td>
                            ...
                            <td>
                              <span style="color: #3b82f6;"><?php echo e($user->email); ?></span>
                            </td>
                            <td>
                              <div class="action-buttons">
                                <a href="<?php echo e(route('accounts.show', $user)); ?>" class="btn btn-info" title="Detail">
                                  <i class="fas fa-eye"></i> Detail
                                </a>
                                <a href="<?php echo e(route('accounts.edit', $user)); ?>" class="btn btn-edit" title="Edit">
                                  <i class="fas fa-edit"></i> Edit
                                </a>
                                <button type="button" onclick="openDeleteModal(<?php echo e($user->id); ?>)" class="btn btn-delete" title="Hapus">
    ...
    <script src="<?php echo e(asset('assets/js/smooth-scrollbar.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/argon-dashboard-tailwind.js')); ?>"></script>
    ...
    <script>
      ...
      function confirmDelete() {
        if (deleteUserId) {
          ...
          form.method = 'POST';
          form.action = '<?php echo e(route("accounts.destroy", ":id")); ?>'.replace(':id', deleteUserId);
...
<?php /**PATH C:\laragon\www\coffee\resources\views/accounts/index.blade.php ENDPATH**/ ?>