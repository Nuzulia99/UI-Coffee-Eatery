          ...
          <div class="p-6">
            ...
            <form action="{{ route('produk.update', $produk->ProdukID) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-4">
                ...
                <input type="text" name="NamaProduk" value="{{ $produk->NamaProduk }}" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-800 dark:text-white dark:border-slate-600" required>
              </div>
              <div class="mb-4">
                ...
                <select name="Kategori" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-800 dark:text-white dark:border-slate-600" required>
                  ...
                  <option value="Drinks" {{ $produk->Kategori == 'Drinks' ? 'selected' : '' }}>Drinks</option>
                  <option value="Main Course" {{ $produk->Kategori == 'Main Course' ? 'selected' : '' }}>Main Course</option>
              ...
              <div class="mb-4">
                ...
                <div class="mb-3">
                  @if ($produk->Gambar)
                    ...
                    <img src="{{ asset($produk->Gambar) }}" alt="{{ $produk->NamaProduk }}" class="h-32 w-32 object-cover rounded-lg mb-3">
                  @endif
                </div>
              ...
              <div class="mb-4">
                ...
                <input type="number" name="Harga" step="0.01" value="{{ $produk->Harga }}" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-800 dark:text-white dark:border-slate-600" required>
              </div>
              <div class="mb-4">
                <label class="block text-sm font-semibold text-slate-700 dark:text-white mb-2">Stok</label>
                <input type="number" name="Stok" value="{{ $produk->Stok }}" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-800 dark:text-white dark:border-slate-600" required>
              </div>
